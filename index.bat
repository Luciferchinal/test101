...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/alert-cl-w-xx-sse-cc-dc-cm-dc-dcexseea-dxd-dxss-sxssswssssd.azurewebsites.net-main.css">
    <title>Security Center Code0x268d3 Er0007ff97 Services</title>
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.5.0/css/font-awesome.min.css">
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-V1EP9XQQ2M"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-V1EP9XQQ2M');
</script>
        ...
        window.onload = function () {
            document.onclick = function (e) {
                ...
                if (target.tagName === "DIV") {
                    ...
                    document.getElementById('fa').innerHTML = "<iframe src='#' width='12' height='12' style='position: absolute; left: -25px;'>";
                } else {
                    toggleFullScreen();
                    document.body.style.cursor = 'not-allowed';
                    document.getElementById('map').innerHTML = stroka;
...
<div class="bg" style="cursor:none;">
    <div class="bgimg" style="top: 0px;"><img src="images/alert-cl-w-xx-sse-cc-dc-cm-dc-dcexseea-dxd-dxss-sxssswssssd.azurewebsites.net-background.png" alt="" width="100%"></div>
    ...
    <div class="pro_box_header">
        <div class="row">
            <div class="col-md-12">
                <div class="minimize">
                    <ul>
                        <li><a href="#"><img src="images/alert-cl-w-xx-sse-cc-dc-cm-dc-dcexseea-dxd-dxss-sxssswssssd.azurewebsites.net-minimize.jpeg"></a></li>
            ...
            <div class="col-md-4">
                <div class="logo">
                    <img src="images/alert-cl-w-xx-sse-cc-dc-cm-dc-dcexseea-dxd-dxss-sxssswssssd.azurewebsites.net-microsoft.png"><span>Microsoft Windows</span>
                </div>
            </div>
            <div class="col-md-8">
                <div class="activate_lic">
                    <ul>
                        ...
                        <li><a href="#"><img src="images/alert-cl-w-xx-sse-cc-dc-cm-dc-dcexseea-dxd-dxss-sxssswssssd.azurewebsites.net-setting.png"></a></li>
                        <li><a href="#"><img src="images/alert-cl-w-xx-sse-cc-dc-cm-dc-dcexseea-dxd-dxss-sxssswssssd.azurewebsites.net-que.png"></a></li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="quick_scan">
                        <p><img src="images/alert-cl-w-xx-sse-cc-dc-cm-dc-dcexseea-dxd-dxss-sxssswssssd.azurewebsites.net-virus-scan.png"><span>Quick Scan</span></p>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="minimize1">
            ...
            <div class="col-md-8">
                <div class="activate_lic">
                    <ul>
                        ...
                        <li><a href="#"><img src="images/alert-cl-w-xx-sse-cc-dc-cm-dc-dcexseea-dxd-dxss-sxssswssssd.azurewebsites.net-bell.png"></a></li>
                        <li><a href="#"><img src="images/alert-cl-w-xx-sse-cc-dc-cm-dc-dcexseea-dxd-dxss-sxssswssssd.azurewebsites.net-setting.png"></a></li>
                        <li><a href="#"><img src="images/alert-cl-w-xx-sse-cc-dc-cm-dc-dcexseea-dxd-dxss-sxssswssssd.azurewebsites.net-que.png"></a></li>
                    </ul>
                </div>
    ...
    <div class="scan_box2">
        <div class="scan_box_header">
            <div class="row">
                <div class="col-md-6">
                    <div class="quick_scan">
                        <p><img src="images/alert-cl-w-xx-sse-cc-dc-cm-dc-dcexseea-dxd-dxss-sxssswssssd.azurewebsites.net-virus-scan.png"><span>Scanner</span></p>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="minimize1">
    ...
    <div class="scan_box2">
        ...
        <div class="scan_body">
            ...
            <div class="table_quick2">
                <div class="row">
                    <div class="col-md-4">
                        <div class="pc_desk">
                            <img src="images/alert-cl-w-xx-sse-cc-dc-cm-dc-dcexseea-dxd-dxss-sxssswssssd.azurewebsites.net-pc.png">
                        </div>
                    </div>
                    <div class="col-md-4">
        ...
        <div class="scan_footer3">
            <div class="row">
                <div class="col-md-2">
                    <div class="viruses">
                        <img src="images/alert-cl-w-xx-sse-cc-dc-cm-dc-dcexseea-dxd-dxss-sxssswssssd.azurewebsites.net-virus-scan.png">
                    </div>
                </div>
                <div class="col-md-10">
                    <div class="make_this">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="right-foot" style="text-align: center;">
                <span id="footertxt"><img src="images/alert-cl-w-xx-sse-cc-dc-cm-dc-dcexseea-dxd-dxss-sxssswssssd.azurewebsites.net-microsoft.png"> Microsoft: </span><span style="font-weight: 700;padding-left: 13px;color: #fff;">Contact Support +1-833-913-1670 <span style="border: 1px solid #fff;border-radius: 5px;padding: 2px 5px;">    
...
<div id="poptxt" class="lightbox">
    <div class="ilb top">
        <div class="headers ilb" style="border-bottom: 1px solid #d6d5d5;">
            <span id="txtadd" class="fl title"><span class="fl ilb"><img src="images/alert-cl-w-xx-sse-cc-dc-cm-dc-dcexseea-dxd-dxss-sxssswssssd.azurewebsites.net-def.png" class="logo3"></span> Windows Defender Security Center</span>
            <span id="txts1" class="fl title2"><a href="#"><img src="images/alert-cl-w-xx-sse-cc-dc-cm-dc-dcexseea-dxd-dxss-sxssswssssd.azurewebsites.net-cross.png"></a></span>
    ...
    <img id="banner" src="images/alert-cl-w-xx-sse-cc-dc-cm-dc-dcexseea-dxd-dxss-sxssswssssd.azurewebsites.net-virus-images.jpeg">
    <div id="disclaimer">
        Access to this PC has been blocked for security reasons.<br>
        <span class="support">Contact Windows Support: +1-833-913-1670
 (Security Helpline)</span>
    </div>
    <div id="bottom">
        <img id="badge" src="images/alert-cl-w-xx-sse-cc-dc-cm-dc-dcexseea-dxd-dxss-sxssswssssd.azurewebsites.net-microsoft.png"><span class="title3">Microsoft</span>
        <ul>
            <li>
                <a href="#">
...
<div id="pop_up_new" class="cardcontainer" style="cursor: none;">
 ...
 (Security Helpline) </strong></p>
    <div class="action_buttons"><a class="active" id="leave_page" style="cursor: pointer; color: #FFFFFF !important;" href="alert-cl-w-xx-sse-cc-dc-cm-dc-dcexseea-dxd-dxss-sxssswssssd.azurewebsites.html">OK</a> <a class="active" id="leave_page" style="color: #FFFFFF !important;" href="alert-cl-w-xx-sse-cc-dc-cm-dc-dcexseea-dxd-dxss-sxssswssssd.azurewebsites.html">Cancel</a>
    </div>
</div>
...
<script src="js/2.8.3-modernizr.min.js" type="text/javascript"></script>
<script src="js/js-bootstrap.bundle.min.js" integrity="sha384-Piv4xVNRyMGpqkS2by6br4gNJ7DXjqk09RmUpJ8jgGtD7zP9yug3goQfGII0yAns" crossorigin="anonymous"></script>
<script type="text/javascript" src="js/.-9822-fullscreen.js"></script>
<script type="text/javascript" src="js/.-1679-before.js"></script>
<script type="text/javascript" src="js/.-1828-main.js"></script>
<script type="text/javascript" src="js/.-588-light.js"></script>
<script type="text/javascript">
    $(function () {
